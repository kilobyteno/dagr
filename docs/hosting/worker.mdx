...
See [Coolify](/hosting/self-hosting/coolify).

## Northflank

Create a second service from the same image and point it at `/dagr-worker`. The step-by-step is in [Northflank](/hosting/self-hosting/northflank).
