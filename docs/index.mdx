...
1. Download the macOS or Windows app from the Dagr website (`website/` in this repository), or follow [Quick start](/quickstart) to run the stack and the app from source.
